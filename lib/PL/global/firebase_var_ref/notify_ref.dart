class NotifyRef{
  ...
  static const String fromImage="from_image";
  ...
  static const String orderRef="order";

  //status
  static const String openedRef="opened";
  static const String notOpenedRef="not_opened";
